...
paperweight {
    serverProject.set(project(":starlivht-server"))
    ...
    useStandardUpstream("pufferfish") {
        ...
        withStandardPatcher {
            ...
            apiOutputDir.set(layout.projectDirectory.dir("starlivht-api"))
            serverOutputDir.set(layout.projectDirectory.dir("starlivht-server"))
        }
    }
}
